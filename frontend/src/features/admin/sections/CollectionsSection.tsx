...
const STATUS_FILTERS = [
  '', 'pending', 'collecting', 'enriching', 'completed',
  'completed_with_errors', 'monitoring', 'failed', 'cancelled',
];
...
const STATUS_COLORS: Record<string, string> = {
  ...
  completed_with_errors: 'bg-orange-500/10 text-orange-700 dark:text-orange-400',
};
