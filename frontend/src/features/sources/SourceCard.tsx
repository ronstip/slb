    ...
    <>
      ...
      >
        ...
        <div
          ...
          onClick={(e) => { e.stopPropagation(); toggleActive(source.collectionId); }}
        >
          <Checkbox
            checked={source.active}
            tabIndex={-1}
            aria-label={source.active ? 'Deactivate collection' : 'Activate collection'}
          />
        </div>
        ...
        <div className="ml-1 shrink-0" onClick={(e) => e.stopPropagation()}>
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48">
              {/* Remove from session — always available */}
