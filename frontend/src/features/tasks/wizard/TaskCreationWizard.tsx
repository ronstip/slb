...
import { TaskSettingsPanel } from './TaskSettingsPanel.tsx';
...
export interface WizardTaskSettings {
...
export function TaskCreationWizard() {
  ...
  // Panel 3 state
  const [taskSettings, setTaskSettings] = useState<WizardTaskSettings>({
    taskType: 'one_shot',
