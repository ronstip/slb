    ...
    <div className={`flex items-center gap-2.5 ${className}`}>
      <div className={`relative flex items-center justify-center ${dim.container}`}>
        <svg viewBox="0 0 40 40" className={dim.svg}>
          ...
          <circle cx="20" cy="20" r="18" className="fill-none stroke-primary/10" strokeWidth="1.5" />
          <circle cx="20" cy="20" r="14" className="fill-none stroke-primary/20" strokeWidth="1.5" />
          <circle cx="20" cy="20" r="10" className="fill-none stroke-primary/30" strokeWidth="1.5" />
          ...
          {/* Connection lines */}
          <line x1="20" y1="20" x2="28" y2="12" className="stroke-primary/30" strokeWidth="1" />
          <line x1="20" y1="20" x2="32" y2="24" className="stroke-primary/30" strokeWidth="1" />
          <line x1="20" y1="20" x2="12" y2="28" className="stroke-primary/30" strokeWidth="1" />
        </svg>
      </div>
      {showText && (
        <span className={`font-semibold ${dim.text}`}>InsightStream</span>
      )}
    </div>
  );
}
