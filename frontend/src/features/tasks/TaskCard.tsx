...
import { runTask, deleteTask, updateTask as patchTask } from '../../api/endpoints/tasks.ts';
import { getMultiCollectionPosts } from '../../api/endpoints/feed.ts';
import { mediaUrl } from '../../api/client.ts';
import { StatusBadge, RUNNABLE_STATUSES, formatLastRun } from './TaskDetailDrawer.tsx';
...
function ThumbnailGrid({ collectionIds, compact }: { collectionIds: string[]; compact?: boolean }) {
  ...
  const { data, isPending } = useQuery({
    queryKey: ['task-thumbnails', collectionIds.join(',')],
