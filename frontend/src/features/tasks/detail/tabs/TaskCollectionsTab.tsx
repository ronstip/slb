...
export function TaskCollectionsTab({ task }: TaskCollectionsTabProps) {
  ...
  // Fetch all collections, then filter to only those in this task
  ...
  // Map → Source objects, filtered to only this task's collections
  ...
  if (taskCollectionIds.size === 0) {
    return (
      <div className="flex flex-1 flex-col items-center justify-center gap-3 text-muted-foreground">
        ...
        <p className="text-xs">Collections will appear here once the task runs.</p>
      </div>
    );
  }
