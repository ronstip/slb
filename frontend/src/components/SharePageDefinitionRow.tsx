...
export function SharePageDefinitionRow({ deliverable: _deliverable }: { deliverable: SharedDeliverable }) {
  return (
    <div className="border-b border-border bg-background/60 mb-6">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 py-3 sm:py-4 text-center">
        <p
          className="text-[10px] sm:text-[11px] uppercase tracking-[0.12em] text-primary font-semibold leading-snug max-w-[640px] mx-auto"
